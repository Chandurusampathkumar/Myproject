...
@Test(priority = 02)
	public void VaildContentUnit() throws Exception
		  {
			try
			{
				Comm.LoginQbend();
				...
				QBA.Explicitwait(BookCatalogContentUnit.BookCatalogAddUnit);
				QBA.clickButton(BookCatalogContentUnit.BookCatalogAddUnit);
				Thread.sleep(3000);
		...
		public void VaildContentUnitTab() throws Exception {
			try {
				...
				QBA.setText(BookCatalogContentUnit.BookcontentUnitProductID, AppConstant.Content_ProductID);
